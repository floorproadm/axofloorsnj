...
const LeadMagnets = () => {
  const leadMagnets = [
    ...
    },
    {
      ...
      benefits: [
        "Comparativo detalhado de 8 tipos de piso",
        "Teste de personalidade para escolha ideal",
        "Prós e contras com base no seu lifestyle",
        "Durabilidade e custo-benefício por tipo",
    ...
    },
    {
      ...
      benefits: [
        "ROI médio de diferentes tipos de piso",
        "Quais reformas trazem maior retorno",
        "Como apresentar para potenciais compradores",
        "Erros que diminuem o valor da propriedade",
        "Timing ideal para renovar antes da venda"
      ],
      value: "$149",
      category: "investment",
      icon: TrendingUp,
  ...
  return (
    <>
      <SEOHead
        title="Guias Gratuitos para Pisos de Madeira | AXO Floors"
        description="Baixe nossos guias especializados sobre pisos de madeira: manutenção, seleção, orçamento e tendências. Conteúdo profissional gratuito para transformar sua casa."
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {leadMagnets.map((magnet) => {
                ...
                return (
                  <Card key={magnet.id} className="group hover:shadow-elegant transition-all duration-300 border-2 hover:border-gold/20">
                    <CardHeader className="text-center pb-4">
                      ...
                      {magnet.value && (
                        <Badge className="mb-3 bg-gold text-navy font-semibold mx-auto">
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="space-y-1">
                          ...
                          {magnet.benefits.length > 3 && (
                            <li className="text-xs text-gold font-medium">
