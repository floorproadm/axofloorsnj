  ...
  return (
    <div className="space-y-1">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <h1 className="text-sm font-heading font-semibold text-foreground capitalize">
          Semana de {format(adjustedStart, "d 'de' MMM yyyy", { locale: ptBR })}
        </h1>
        <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => setWeekOffset((o) => o + 1)}>
          ...
          <div key={day.toISOString()} className="mb-4">
            ...
            {dayAppointments.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-6 text-muted-foreground">
                ...
                <p className="text-xs">Nenhum job agendado</p>
              </div>
            ) : (
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <div className="min-w-0 flex-1">
                            <h3 className="font-semibold text-sm text-foreground leading-tight">
                              {appt.appointment_type === "production" ? "Produção" :
                               appt.appointment_type === "measurement" ? "Visita de Medição" :
                               appt.appointment_type === "follow_up" ? "Acompanhamento" :
                               appt.appointment_type === "inspection" ? "Inspeção" :
