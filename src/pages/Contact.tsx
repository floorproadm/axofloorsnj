        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {contactInfo.map((contact, index) => (
              <Card key={index} className="group hover:shadow-gold transition-smooth hover:-translate-y-2 text-center">
            ...
            <Card className="shadow-elegant">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea 
                    id="message" 
                    placeholder="Tell us about your project - room size, current flooring, specific requirements, etc."
                    rows={4}
                  />
                </div>
