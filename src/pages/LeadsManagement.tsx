    ...
    <div className="min-h-screen bg-background p-4 sm:p-6">
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 sm:mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-navy">Leads Management</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4 mb-6 sm:mb-8">
          <Card className="col-span-1">
            <CardContent className="p-3 sm:p-4 text-center">
              <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-full mb-2 mx-auto">
                <Users className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
              </div>
              <div className="text-lg sm:text-xl font-bold text-navy">{stats.totalLeads}</div>
          ...
          <Card className="col-span-1">
            <CardContent className="p-3 sm:p-4 text-center">
              ...
              <div className="text-lg sm:text-xl font-bold text-navy">{stats.newLeads}</div>
          ...
          <Card className="col-span-1">
            <CardContent className="p-3 sm:p-4 text-center">
              <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-yellow-100 rounded-full mb-2 mx-auto">
                <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-600" />
              </div>
              <div className="text-lg sm:text-xl font-bold text-navy">{stats.contactedLeads}</div>
          ...
          <Card className="col-span-1">
            <CardContent className="p-3 sm:p-4 text-center">
              <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-green-100 rounded-full mb-2 mx-auto">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" />
              </div>
              <div className="text-lg sm:text-xl font-bold text-navy">{stats.qualifiedLeads}</div>
          ...
          <Card className="col-span-1">
            <CardContent className="p-3 sm:p-4 text-center">
              <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-purple-100 rounded-full mb-2 mx-auto">
                <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600" />
              </div>
              <div className="text-lg sm:text-xl font-bold text-navy">{stats.convertedLeads}</div>
          ...
          <Card className="col-span-1">
            <CardContent className="p-3 sm:p-4 text-center">
              <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-gold/20 rounded-full mb-2 mx-auto">
                <Star className="w-4 h-4 sm:w-5 sm:h-5 text-gold" />
              </div>
              <div className="text-lg sm:text-xl font-bold text-navy">{stats.conversionRate}%</div>
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-sm text-grey">
                            {lead.email && (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  <div>
                                    ...
                                    <div className="mt-2 space-y-1">
                                      {lead.email && <p className="text-sm text-grey break-all">{lead.email}</p>}
                      ...
                      {(lead.services.length > 0 || lead.budget || lead.room_size) && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm border-t pt-3">
                          {lead.services.length > 0 && (
                            <div className="min-w-0">
                              <span className="font-medium text-navy">Services:</span>
                              <p className="text-grey break-words">{lead.services.join(', ')}</p>
                            </div>
                          )}
                          {lead.budget && (
                            <div>
                      ...
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 pt-3 border-t">
                        <Button size="sm" className="gold-gradient text-black w-full sm:w-auto">
