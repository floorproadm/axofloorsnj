    ...
    <SidebarProvider defaultOpen={defaultSidebarOpen}>
      ...
      <div className="flex w-full min-w-0 h-dvh overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 min-h-0">
          ...
          <main className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden px-4 pt-4 pb-[calc(7rem+env(safe-area-inset-bottom))] sm:px-6 sm:pt-6 sm:pb-[calc(7rem+env(safe-area-inset-bottom))] animate-fade-in max-w-full min-w-0">
            {children}
          </main>
        </div>
